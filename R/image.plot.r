"image.plot" <-
function (..., add = FALSE, nlevel = 32, legend.shrink = 0.9, legend.width = 0.04, 
    graphics.reset = FALSE, horizontal = FALSE, offset = 2 * legend.width, 
    bigplot = NULL, smallplot = NULL, legend.only = FALSE, col = topo.colors(64)) 
{
